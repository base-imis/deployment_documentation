...
- [**Geoserver Setup**](https://github.com/base-imis/deployment_documentation/tree/main/geoserver_setup): A folder containing the config.yml file required for setting up the printing for MapFish Print in Geoserver, and the pre-set workspace for IMIS.   
